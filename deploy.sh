...
tar czf "$DEPLOY_TMP" $(find . -maxdepth 1 -type f ! -name "data.json" ! -name "hands.jsonl" ! -name "secret.key" ! -name "mail.json" ! -name "feedback.jsonl" ! -name "squid-rounds.jsonl") avatars
