...
const I18N = {
    zh: {
        ...
        // —— 注销账号（2026-09-16）
        'err.delNoUser': '账号不存在',
        'err.delNeedPwd': '请输入密码以确认注销',
        'err.delBadPwd': '密码不正确',
        'err.delInRoom': '你还在牌局里，请先退出并结算后再注销',
        'err.delLastAdmin': '你是唯一的管理员，请先指定另一位管理员',
        'err.delFailed': '注销失败',
        'err.notAdmin': '无管理员权限',
        ...
        'fr.tabFriends': '我的牌友',
        'fr.tabRecent': '一起玩过',
        'fr.searchPh': '输入牌友号或用户名',
        'fr.search': '搜索',
        'fr.noteFor': '备注',
        'fr.notePrivate': '只有你自己看得到',
        'fr.notePh': '例如：爱诈唬 / 只玩大牌',
        'btn.ok': '确定',
        'btn.cancel': '取消',
        'btn.save': '保存',
        // —— 牌友：服务端提示
        ...
        'srv.friend.pending': '⚠️ 申请已发出，等对方同意',
        'srv.friend.requested': '✅ 申请已发出',
        'srv.friend.accepted': '✅ 你们成为牌友了',
        'srv.friend.noRequest': '⚠️ 这条申请已经不在了',
        'srv.friend.noteFailed': '⚠️ 只能给牌友写备注',
        ...
        'srv.friend.blocked': '✅ 已拉黑，对方无法再向你发送申请',
        'srv.friend.unblocked': '✅ 已解除拉黑',
        'srv.friend.youBlocked': '⚠️ 你拉黑了 TA，先在「我的牌友」里解除再加',
        ...
        'tm.standup': '🧍 站起围观', 'tm.pause': '⏸️ 暂停发牌', 'tm.matchSettings': '⚙️ 比赛设置', 'tm.fair': '🔒 公平性验证', 'tm.leave': '🚪 退出比赛', 'tm.dissolve': '🛑 解散比赛',
        ...
        'inv.label': '邀请信息', 'inv.friends': '👥 邀请在线牌友', 'inv.filterPh': '输入名字筛选', 'inv.copy': '一键复制', 'inv.open': '🔓 开放入场', 'inv.reset': '↻ 重置邀请', 'inv.close': '关闭',
    ...
    en: {
        ...
        // -- account deletion (2026-09-16)
        'err.delNoUser': 'Account not found',
        'err.delNeedPwd': 'Enter your password to confirm deletion',
        'err.delBadPwd': 'Incorrect password',
        'err.delInRoom': 'You are still at a table. Please leave and cash out first.',
        'err.delLastAdmin': 'You are the only admin. Assign another admin first.',
        'err.delFailed': 'Deletion failed',
        ...
        'nav.me': 'Me',
        'lobby.myRooms': 'My games',
        'disc.all': 'All',
        'disc.cash': 'Cash',
        'disc.sng': 'SNG',
        'me.inbox': 'Messages',
        'me.checkin': 'Daily check-in',
        'me.stats': 'Career stats',
        'me.hands': 'Hand history',
        'me.profile': 'Profile & avatar',
        ...
        'fr.searchPh': 'Friend code or exact username',
        'fr.search': 'Search',
        'fr.noteFor': 'Note for',
        'fr.notePrivate': 'Only you can see this',
        'fr.notePh': 'e.g. bluffs a lot / only plays big hands',
        'btn.ok': 'OK',
        'btn.cancel': 'Cancel',
        'btn.save': 'Save',
        ...
        'srv.friend.pending': '⚠️ Request already sent — waiting for them',
        'srv.friend.requested': '✅ Request sent',
        'srv.friend.accepted': '✅ You are now poker friends',
        'srv.friend.noRequest': '⚠️ That request is no longer there',
        'srv.friend.noteFailed': '⚠️ You can only add notes for friends',
        ...
        'srv.friend.blocked': '✅ Blocked - they can no longer send you requests',
        'srv.friend.unblocked': '✅ Unblocked',
        'srv.friend.youBlocked': '⚠️ You blocked them - unblock under My friends first',
        ...
        'tm.standup': '🧍 Stand up (watch)', 'tm.pause': '⏸️ Pause dealing', 'tm.matchSettings': '⚙️ Game settings', 'tm.fair': '🔒 Fairness', 'tm.leave': '🚪 Leave game', 'tm.dissolve': '🛑 Dissolve game',
        ...
        'inv.label': 'Invite', 'inv.friends': '👥 Invite friends online', 'inv.filterPh': 'Filter by name', 'inv.copy': 'Copy', 'inv.open': '🔓 Open entry', 'inv.reset': '↻ Reset invite', 'inv.close': 'Close',
