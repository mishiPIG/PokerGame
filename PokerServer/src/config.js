...
const RUNIT_MAX = 5;
const RUNIT_DECIDE_MS = 25000;
const STRADDLE_DECISION_MS = 15000;
const STRADDLE_INTERMISSION_MS = 4500;
const SQUID_PENALTY_BB_MIN = 1;
const SQUID_PENALTY_BB_MAX = 10;
const SQUID_PENALTY_BB_DEFAULT = 2;
const SQUID_CLAIM_WINDOW_MS = 10000;
...
module.exports = {
    ...
    STRADDLE_DECISION_MS, STRADDLE_INTERMISSION_MS,
    SQUID_PENALTY_BB_MIN, SQUID_PENALTY_BB_MAX, SQUID_PENALTY_BB_DEFAULT, SQUID_CLAIM_WINDOW_MS,
    FIXED_BUYIN, SNG_BUYIN_TIERS,
